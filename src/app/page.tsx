...
export default function StorePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 flex flex-col">
      ...
      <section className="relative bg-neutral-50 border-b border-neutral-200 py-20 lg:py-28 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-neutral-600 mb-8 max-w-2xl font-normal">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              <a
                href="#store"
                className="bg-neutral-900 hover:bg-neutral-800 text-white text-center px-8 py-4 rounded-full font-semibold text-sm transition-all shadow-lg hover:shadow-xl"
              >
                Explore Collection
              </a>
              <button
      ...
      <main id="store" className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 border-b border-neutral-200 pb-6 space-y-4 md:space-y-0">
          <div>
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-24 bg-neutral-50 rounded-2xl border border-neutral-200">
            <p className="text-lg font-medium text-neutral-700">No products found matching your criteria.</p>
            <button
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xl font-extrabold text-neutral-900">${product.price}</span>
                    </div>
                    <h3 className="text-lg font-bold text-neutral-900 group-hover:text-neutral-600 transition-colors mb-2">
                      {product.name}
                    </h3>
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-between overflow-y-auto max-h-[80vh] md:max-h-none">
              <div>
                ...
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <span className="text-neutral-400 text-sm">({selectedProduct.reviewsCount} verified reviews)</span>
                </div>
                <p className="text-3xl font-black text-neutral-900 mb-6">
              ...
              <button
                ...
                className="w-full bg-neutral-900 hover:bg-neutral-800 text-white py-4 rounded-full font-bold text-sm transition-all shadow-lg"
              >
                ...
                <>
                  {cart.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {cart.map(item => (
                        <div key={item.id} className="flex items-center space-x-4 bg-neutral-50 p-4 rounded-2xl border border-neutral-200">
                          ...
                          <div className="flex-grow">
                            ...
                            <p className="text-xs text-neutral-500 mt-0.5">${item.price} each</p>
            ...
            {checkoutStep !== 'success' && cart.length > 0 && (
              <div className="p-6 border-t border-neutral-200 bg-neutral-50">
                <div className="space-y-2 mb-4 text-sm">
                  ...
                  <div className="flex justify-between text-lg font-black text-neutral-900 pt-2 border-t border-neutral-200">
                    <span>Total</span>
                    <span>${total}</span>
                  </div>
                </div>
                ...
                {checkoutStep === 'cart' ? (
                  ...
                  <div className="flex space-x-3">
                    <button
                      ...
                      className="w-1/3 border border-neutral-300 hover:border-neutral-900 text-neutral-900 py-4 rounded-full font-bold text-sm transition-all bg-white"
                    >
                      Back
                    </button>
                    <button
                      type="submit"
                      form="shipping-form"
                      className="w-2/3 bg-neutral-900 hover:bg-neutral-800 text-white py-4 rounded-full font-bold text-sm transition-all shadow-lg"
                    >
                      Place Order (${total})
                    </button>
                  </div>
      ...
      <footer className="bg-neutral-900 text-white py-16 border-t border-neutral-800 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-400 mb-4">Subscribe to receive early access to new drops and exclusive member pricing.</p>
              <form onSubmit={(e) => { e.preventDefault(); showToast("Successfully subscribed to VerveTech drops!"); }} className="flex space-x-2">
                <input
                  type="email"
                  required
                  placeholder="Enter your email"
                  className="bg-neutral-800 text-white text-xs px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-white flex-grow"
                />
                <button
                  type="submit"
                  className="bg-white text-neutral-900 text-xs font-bold px-4 py-3 rounded-xl hover:bg-neutral-200 transition-all"
                >
                  Join
                </button>
              </form>
